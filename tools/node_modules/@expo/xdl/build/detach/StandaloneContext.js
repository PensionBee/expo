...
_defineProperty(StandaloneContext, "createUserContext", (projectPath, exp, publishedUrl) => {
  ...
  _StandaloneBuildFlags().default.createEmpty());
  context.config = exp;
  return context;
});

_defineProperty(StandaloneContext, "createServiceContext", (expoSourcePath, archivePath, manifest, privateConfig, testEnvironment, build, publishedUrl, releaseChannel, shellAppSdkVersion, packagesToInstallWhenEjecting) => {
