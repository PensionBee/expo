...
function _renderDetachedPostinstall(sdkVersion, isServiceContext) {
  ...
  const maybeFrameworkSearchPathDef = sdkMajorVersion < 33 ? `
          ...
          config.build_settings['FRAMEWORK_SEARCH_PATHS'] << '${podsRootSub}/GoogleMaps/Maps/Frameworks'` : ''; // In SDK39, in preparation for iOS 14 we've decided to remove IDFA code.
  ...
  const excludeIdfaCodeFromBranchSinceSDK39 = sdkMajorVersion >= 39 ? `
